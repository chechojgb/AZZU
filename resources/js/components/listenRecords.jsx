...
import { HiOutlineSpeakerWave, HiMiniMicrophone, HiMiniStopCircle, HiMiniPlayCircle } from "react-icons/hi2";
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white">
              {isListening ? "Escuchando llamada" : "No estás escuchando"}
            </h2>
      ...
      <div className="flex flex-wrap gap-4">
        {isListening ? (
          <>
            ...
            <button
              onClick={() => setMode(mode === "normal" ? "whisper" : "normal")}
            ...
            className="flex items-center gap-2 px-6 py-3 rounded-lg bg-blue-100 dark:bg-blue-800/70 text-gray-900 dark:text-white shadow-inner hover:shadow-md transition"
          >
